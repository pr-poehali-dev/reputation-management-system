            ...
            {[
              {
                ...
                features: [
                  ...
                  "Google: 15 отзывов",
                  "ИТОГО: 50 отзывов",
                  "Мониторинг негатива и отзывов",
                  "Поведенческие факторы",
                  "Написание текстов копирайтером по SEO",
                  "Использование фото"
                ]
              },
              {
                ...
                oldPrice: "60 000 ₽",
                popular: true,
                bonus: "БЕСПЛАТНО 2ГИС: 20 отзывов",
                features: [
                  "Яндекс: 60 отзывов",
                  "YCLIENTS: 60 отзывов",
                  "2ГИС БОНУС: 20 отзывов",
                  "ИТОГО: 140 отзывов",
                  "Мониторинг негатива и отзывов",
                  "Поведенческие факторы",
                  "Написание текстов копирайтером по SEO",
              ...
              },
              {
                ...
                oldPrice: "114 000 ₽",
                popular: false,
                bonus: "БЕСПЛАТНО 10 ОТЗЫВОВ + 2ГИС: 60 отзывов",
                features: [
                  "Яндекс: 120 отзывов",
                  "YCLIENTS: 120 отзывов",
                  "2ГИС БОНУС: 60 отзывов",
                  "ИТОГО: 300 отзывов",
                  "Мониторинг негатива и отзывов",
                  "Поведенческие факторы",
                  "Написание текстов копирайтером по SEO",
